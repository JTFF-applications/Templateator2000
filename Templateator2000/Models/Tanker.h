...
public:
    ...
    friend bool operator==(const Tanker& lhs, const Tanker& rhs);
    friend bool operator!=(const Tanker& lhs, const Tanker& rhs) { return !(lhs == rhs); }
...
inline bool operator==(const Tanker& lhs, const Tanker& rhs)
{
    return lhs.Type == rhs.Type
           && lhs.Coalition == rhs.Coalition
