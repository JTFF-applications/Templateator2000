...
AtisTacanPage::AtisTacanPage(QWidget* parent)
	: QWizardPage(parent)
{
	setTitle("Atis - Tacan Information");

	m_label = new QLabel("Select the airport tacan.", this);
...
void AtisTacanPage::initializePage()
{
...
bool AtisTacanPage::validatePage()
{
...
int AtisTacanPage::nextId() const
{
