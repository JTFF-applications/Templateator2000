...
AwacsFlightPage::AwacsFlightPage(QWidget* parent)
	: QWizardPage(parent)
{
	setTitle("Awacs Flight Information");

	m_feet_label = new QLabel("ft", this);
	m_knots_label = new QLabel("kts", this);

	m_altitude_label = new QLabel("Select the awacs altitude (ft):", this);
	...
	m_speed_label = new QLabel("Select the awacs ground speed (kts):", this);
...
void AwacsFlightPage::initializePage()
{
...
bool AwacsFlightPage::validatePage()
{
