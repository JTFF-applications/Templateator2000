...
AwacsRespawnPage::AwacsRespawnPage(QWidget* parent)
	: QWizardPage(parent)
{
	setTitle("Awacs Respawn Options");

	m_label = new QLabel("Do you want the awacs to respawn every time he is killed:", this);
...
void AwacsRespawnPage::initializePage()
{
...
bool AwacsRespawnPage::validatePage()
{
