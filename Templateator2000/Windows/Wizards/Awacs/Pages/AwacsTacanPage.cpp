...
AwacsTacanPage::AwacsTacanPage(QWidget* parent)
	: QWizardPage(parent)
{
	setTitle("Awacs Tacan Information");

	m_label = new QLabel("Select the awacs tacan information. "
...
void AwacsTacanPage::initializePage()
{
...
bool AwacsTacanPage::validatePage()
{
