...
function SaveTable(Table)
   ...
   local outFuncs = {
      ...
      ['number']  = function(value) if(math.tointeger(value)) then return math.tointeger(value) else return string.format('%f',value) end end;
   }
   local outFuncsMeta = {
...
-- ******************************************************** --
--        ----      TABLE FIND KEY BY VALUE                 --
-- ******************************************************** --

function find_table_key(t, value)
...
function GetAirbase(dcs_name)
   for k, v in pairs(AIRBASE.Caucasus) do
    ...
    for k, v in pairs(AIRBASE.Syria) do
       if(v == dcs_name) then
           return 'AIRBASE.Syria.'..k
       end
    end
   for k, v in pairs(AIRBASE.PersianGulf) do
       if(v == dcs_name) then
           return 'AIRBASE.PersianGulf.'..k
       end
   end
    for k, v in pairs(AIRBASE.Nevada) do
       if(v == dcs_name) then
           return 'AIRBASE.Nevada.'..k
       end
    end
   for k, v in pairs(AIRBASE.Normandy) do
       if(v == dcs_name) then
           return 'AIRBASE.Normandy.'..k
       end
   end
   for k, v in pairs(AIRBASE.TheChannel) do
       if(v == dcs_name) then
   ...
   for k, v in pairs(AIRBASE.SouthAtlantic) do
       if(v == dcs_name) then
           return 'AIRBASE.SouthAtlantic.'..k
       end
   end
end
